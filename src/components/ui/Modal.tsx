    ...
    <>
      <div className="fixed inset-0 z-50 flex items-center justify-center">
        <div className="w-full h-[100vh] md:w-[500px]  flex items-center justify-center">
          <div className="fixed inset-0 bg-dark opacity-70"></div>
          <div className="relative z-10 flex w-full h-full p-8 bg-white rounded-none dark:bg-dark md:rounded-lg md:h-auto ">
            <button
              onClick={onClose}
